...
| optional-connect-params    | - | Makes Connect-specific headers and query parameters (`Connect-Protocol-Version`, `encoding`) optional instead of required. Useful for simpler examples.                                                                                   |
